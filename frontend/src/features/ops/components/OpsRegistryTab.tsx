...
import { AdaptationCandidatesPanel } from "./AdaptationCandidatesPanel";
...
export function OpsRegistryTab() {
  ...
  return <div style={{ display: "grid", gap: 12 }}>
    ...
    <AdaptationCandidatesPanel activeModelId={activeModelId} onRegistryRefresh={() => registryState.refresh(false)} />
