...
export function OpsControlTower({ status, loading, onRefreshStatus, onRefreshJobs }: OpsControlTowerProps) {
  return (
    <section className="panel">
      <h3>Ops control tower</h3>
      <p className="muted">
        After submitting retraining, use these refresh controls to verify progress across status and jobs.
      </p>
